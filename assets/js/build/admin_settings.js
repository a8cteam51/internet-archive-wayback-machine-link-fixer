...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (API_ACCESS_KEY || API_SECRET_KEY) {
      ...
      const shouldWatch = API_ACCESS_KEY && API_ACCESS_KEY.dataset.isValid === '0' || API_SECRET_KEY && API_SECRET_KEY.dataset.isValid === '0';
    ...
    function toggleElements(isChecked, groupName) {
      ...
      const fieldList = 'link_fixer' === groupName ? '.iawmlf_toggle_setting__fixer' : '.iawmlf_toggle_setting__auto_archiver';
